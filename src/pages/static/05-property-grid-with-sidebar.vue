        ...
        <div class="row">
          <div class="col-md-9 col-sm-9 left-block">
            <div class="sec-title icon-wrap">
              ...
              <div class="icon-hold">
                <a href="03-property-list-with-sidebar.html" class="btn">
                  <i class="fa fa-list-ul"></i>
                </a>

                <a href="05-property-grid-with-sidebar.html" class="btn active">
                  <i class="fa fa-th"></i>
                </a>
              </div>
              <!--icon hold-->
            ...
            <div class="row mb-20 ppt-list-wrap">
              <div class="col-md-4 col-sm-4 mb-30">
                <div class="ppt-list featured gd-vw">
                  <figure>
              ...
              <div class="col-md-4 col-sm-4 mb-30">
                <div class="ppt-list gd-vw">
                  <figure>
                    ...
                    <span class="tag right text-uppercase bg-blue">for sale</span>
                    <a href="#" class="image-effect overlay">
                      <img src="/static/images/p-gv-7.jpg" alt="">
                    </a>
                  </figure>
                  <!--fig-->
              ...
              <div class="col-md-4 col-sm-4 mb-30">
                <div class="ppt-list gd-vw">
                  <figure>
                    ...
                    <span class="tag right text-uppercase primary-bg">for rent</span>
                    <a href="#" class="image-effect overlay">
                      <img src="/static/images/p-gv-8.jpg" alt="">
                    </a>
                  </figure>
                  <!--fig-->
              ...
              <div class="col-md-4 col-sm-4 mb-30">
                <div class="ppt-list gd-vw">
                  <figure>
                    ...
                    <span class="tag right text-uppercase primary-bg">for rent</span>
                    <a href="#" class="image-effect overlay">
                      <img src="/static/images/p-gv-9.jpg" alt="">
                    </a>
                  </figure>
                  <!--fig-->
